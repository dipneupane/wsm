...
import { deleteAssembly } from '@/services/assembly';
...
import { ASSEMBLY_QUERY_KEY, SUPPLIER_QUERY_KEY } from '@/config/query-keys';
    ...
    <Dialog>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem>
            <Link className="w-full" href={`/assemblies/${row.original.id}`}>
              View
            </Link>
          </DropdownMenuItem>
          <DropdownMenuItem>
            <Link
              className="w-full"
              href={`/assemblies/${row.original.id}/edit`}
            >
              Edit
            </Link>
          </DropdownMenuItem>
